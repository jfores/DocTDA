...
```{r}
barcode_individual <- compute_homology(alpha_carbs[[1]])

barcode_plot <- plot_barcode(barcode_individual)

dimensions_plot <- plot_dimensions(barcode_individual)

plot_grid(barcode_plot,dimensions_plot)
```
